...
export default function EventGallery() {
    const events = getGalleryItems('event');
        ...
        <main className="min-h-screen bg-[#F4F9F6] pt-32 pb-20 px-6 md:px-12">
            ...
            <Reveal>
                <div className="flex flex-col items-center text-center mb-20">
                    <div className="flex items-center gap-4 mb-4">
                        ...
                        <span className="text-xs font-sans tracking-widest text-[#083316] uppercase">Event</span>
                    </div>
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-16">
                {events.map((event, index) => (
                    <Reveal key={event.slug} delay={index * 0.1} className="h-full">
                        <Link
