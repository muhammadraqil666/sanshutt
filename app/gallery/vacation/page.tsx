...
export default function VacationGallery() {
    const vacations = getGalleryItems('vacation');
            ...
            <main className="flex min-h-screen flex-col items-center justify-center bg-[#F4F9F6] text-[#083316]">
                <Reveal>
                    <div className="text-center">
                        <h1 className="text-4xl font-serif italic mb-4">Vacation Archive</h1>
        ...
        <main className="min-h-screen bg-[#F4F9F6] pt-32 pb-20 px-6 md:px-12">
            ...
            <Reveal>
                <div className="flex flex-col items-center text-center mb-20">
                    <div className="flex items-center gap-4 mb-4">
                        ...
                        <span className="text-xs font-sans tracking-widest text-[#083316] uppercase">Vacation</span>
                    </div>
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-16">
                {vacations.map((vacation, index) => (
                    <Reveal key={vacation.slug} delay={index * 0.1} className="h-full">
                        <Link
                            href={`/gallery/vacation/${vacation.slug}`}
                        ...
                        >
                            ...
                            <button
                                ...
                                onClick={(e) => {
                                    e.preventDefault();
                                    e.stopPropagation();
                                    setSelectedImage(vacation.cover);
                                }}
                            >
                            ...
                            <div className="flex flex-col items-center text-center gap-2 mt-auto">
                                ...
                                <p className="text-[10px] font-sans tracking-[0.2em] text-[#083316]/60 uppercase font-medium">
                                    {vacation.location} • {vacation.date}
                                </p>
                            </div>
                        </Link>
                    </Reveal>
            ...
            {selectedImage && (
                ...
                >
                    ...
                    >
                        <Image
                            src={selectedImage}
                            alt="Vacation Preview Fullscreen"
                            width={1920}
                            height={1080}
